...
export const growthDataElements = {
    DATA_ELEMENT_WEIGHT: "T9nWERM3O4m",
    DATA_ELEMENT_LENGTH_HEIGHT: "DTzq8JDlvte",
    DATA_ELEMENT_HEAD_CIRCUMFERENCE: "DHHJzQDTTVF",
    AGE_AT_THE_TIME_OF_REPORTING_MONTHS: "bJLynrdYjSq",
    INDICATOR_WEIGHT_FOR_AGE: "EdIhdlbGMDU",
    INDICATOR_LENGTH_HEIGHT_FOR_AGE: "CFN5sYAMDUz",
    INDICATOR_WEIGHT_FOR_LENGTH_HEIGHT: "ecYyy4QkkEx",
    INDICATOR_HEAD_CIRCUMFERENCE_FOR_AGE: "",
};